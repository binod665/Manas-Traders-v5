    ...
    <section id="products-section" className="my-10 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2 self-start lg:self-center">
            <button
              ...
              className="inline-flex items-center gap-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-bold px-3.5 py-2 rounded-xl border border-emerald-200 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
            >
        ...
        <div className="mt-4 pt-2">
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
              />
              {searchQuery && (
                <button
          ...
          <div className="flex items-center gap-2 mt-3 overflow-x-auto pb-1 text-xs no-scrollbar">
            <span className="text-gray-400 font-semibold shrink-0 flex items-center gap-1 text-[11px]">
        ...
        <div className="mt-5 pt-4 border-t border-gray-100 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 self-end lg:self-center">
            ...
            <select
              ...
              className="bg-gray-50 border border-gray-200 rounded-xl px-3 py-1.5 text-xs font-bold text-gray-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 shadow-2xs cursor-pointer"
            >
        ...
        {(selectedCategory !== 'all' || searchQuery || pricePreset !== 'all' || showWishlistOnly) && (
          <div className="mt-3 pt-2 flex flex-wrap items-center gap-2 text-xs">
            ...
            {selectedCategory !== 'all' && (
              <span className="bg-emerald-50 text-emerald-800 px-2.5 py-0.5 rounded-lg border border-emerald-200 font-medium flex items-center gap-1">
            ...
            {showWishlistOnly && (
              <span className="bg-red-50 text-red-800 px-2.5 py-0.5 rounded-lg border border-red-200 font-medium flex items-center gap-1">
                Wishlist Items Only
                <X
                  className="w-3 h-3 cursor-pointer hover:text-red-950"
            ...
            <button
              ...
              className="text-xs font-bold text-emerald-800 hover:underline ml-auto"
            >
              Reset All
            </button>
          </div>
      ...
      {paginatedProducts.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-3xl border border-gray-100 p-8 shadow-xs">
          ...
          <button
            onClick={handleResetFilters}
            className="mt-4 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-xs px-5 py-2.5 rounded-xl cursor-pointer transition-colors shadow-xs"
          >
            Reset All Filters
          </button>
        </div>
      ...
      {totalItems > 0 && (
        <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-gray-500 font-medium">
            ...
            <span className="font-bold text-emerald-800">{totalItems}</span> grocery items
          </div>
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-2 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100 disabled:opacity-40 disabled:hover:bg-gray-50 text-gray-700 transition-all cursor-pointer"
              title="Previous Page"
            >
            ...
            <div className="ml-2 pl-2 border-l border-gray-200 flex items-center gap-1.5 text-xs text-gray-500">
              <span>Per page:</span>
              <select
                value={itemsPerPage}
                onChange={(e) => {
                ...
                className="bg-gray-50 border border-gray-200 rounded-lg px-2 py-1 text-xs font-bold text-gray-800 focus:outline-none"
              >
