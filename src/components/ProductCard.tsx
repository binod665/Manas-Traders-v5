...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="group relative bg-white rounded-2xl border border-gray-100/80 shadow-xs hover:shadow-xl hover:border-emerald-200 transition-all duration-300 flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative aspect-4/3 w-full bg-gray-50 overflow-hidden">
        ...
        <div className="absolute top-2.5 right-2.5 flex flex-col gap-2 z-10">
          ...
          <button
            ...
            className="p-2 rounded-full bg-white/90 hover:bg-white text-gray-700 hover:text-emerald-700 backdrop-blur-md shadow-md transition-all"
            title="Quick View"
          >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <h3
            onClick={handleQuickView}
            className="font-bold text-gray-900 text-base leading-snug line-clamp-2 hover:text-emerald-700 cursor-pointer transition-colors mb-2"
          >
            {title}
          </h3>
        ...
        <div className="pt-3 border-t border-gray-100 mt-2">
          <div className="flex items-baseline justify-between gap-2 mb-3">
            <div>
              ...
              <span className="text-xs text-gray-500 ml-1">/ {selectedUnit}</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden bg-gray-50">
              ...
              <span className="px-2 text-xs font-bold text-gray-800 w-6 text-center">
                {quantity}
              </span>
              <button
            ...
            <button
              ...
              className="flex-1 bg-emerald-800 hover:bg-emerald-900 disabled:bg-gray-200 disabled:text-gray-400 text-white py-2 px-3 rounded-xl font-semibold text-xs flex items-center justify-center gap-1.5 shadow-xs transition-all active:scale-95"
            >
