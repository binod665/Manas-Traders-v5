...
function StoreMain() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/60 font-sans text-gray-800 flex flex-col justify-between">
      <div>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {selectedCategory !== 'all' && (
                <button
                  ...
                  className="text-xs font-bold text-emerald-800 hover:underline bg-emerald-50 px-3 py-1 rounded-xl border border-emerald-200"
                >
              ...
              <button
                ...
                className={`group flex flex-col items-center justify-center p-3 rounded-2xl border transition-all text-center cursor-pointer ${
                  selectedCategory === 'all'
                    ...
                    : 'bg-white hover:bg-emerald-50 text-gray-800 border-gray-100 shadow-xs'
                }`}
              >
                <div className="w-12 h-12 rounded-xl bg-emerald-100 text-emerald-800 flex items-center justify-center mb-1.5 font-bold text-lg">
                  🛍️
                </div>
                <span className="font-semibold text-xs leading-tight">
                  {getTranslation(language, 'allCategories')}
                </span>
                <span className="text-[10px] text-emerald-200 opacity-80 mt-0.5">
