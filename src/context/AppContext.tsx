...
interface AppContextType {
  ...
  // Modals
  activeModal: 'quickView' | 'checkout' | 'auth' | 'registerPage' | 'supabaseConfig' | 'admin' | 'githubGuide' | 'contact' | 'esewaQr' | 'khaltiQr' | 'orderTracking' | null;
  setActiveModal: (modal: 'quickView' | 'checkout' | 'auth' | 'registerPage' | 'supabaseConfig' | 'admin' | 'githubGuide' | 'contact' | 'esewaQr' | 'khaltiQr' | 'orderTracking' | null) => void;
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activeModal, setActiveModal] = useState<'quickView' | 'checkout' | 'auth' | 'registerPage' | 'supabaseConfig' | 'admin' | 'githubGuide' | 'contact' | 'esewaQr' | 'khaltiQr' | 'orderTracking' | null>(null);
